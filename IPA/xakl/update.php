...
<td>Nama</td>
<td>NIS</td>
<td align=center>IPA Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>IPA Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="ipap[]" class="txtField" value="<?php echo $row['ipap']; ?>"></td>
<td><input type="text" name="desipap[]" class="txtField" value="<?php echo $row['desipap']; ?>"></td>
<td><input type="text" name="ipak[]" class="txtField" value="<?php echo $row['ipak']; ?>"></td>
<td><input type="text" name="desipak[]" class="txtField" value="<?php echo $row['desipak']; ?>"></td>
