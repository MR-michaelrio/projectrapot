...
<td>Nama</td>
<td>NIS</td>
<td align=center>Olahraga Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Olahraga Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="orp[]" class="txtField" value="<?php echo $row['orp']; ?>"></td>
<td><input type="text" name="desorp[]" class="txtField" value="<?php echo $row['desorp']; ?>"></td>
<td><input type="text" name="ork[]" class="txtField" value="<?php echo $row['ork']; ?>"></td>
<td><input type="text" name="desork[]" class="txtField" value="<?php echo $row['desork']; ?>"></td>
