...
<td>Nama</td>
<td>NIS</td>
<td align=center>Ekonomi Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Ekonomi Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="ekonomip[]" class="txtField" value="<?php echo $row['ekonomip']; ?>"></td>
<td><input type="text" name="desekonomip[]" class="txtField" value="<?php echo $row['desekonomip']; ?>"></td>
<td><input type="text" name="ekonomik[]" class="txtField" value="<?php echo $row['ekonomik']; ?>"></td>
<td><input type="text" name="desekonomik[]" class="txtField" value="<?php echo $row['desekonomik']; ?>"></td>
