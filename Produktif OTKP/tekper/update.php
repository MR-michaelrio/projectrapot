...
<td>Nama</td>
<td>NIS</td>
<td align=center>Teknologi Perkantoran<br>Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Teknologi Perkantoran<br>Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="tekperkantoranp[]" class="txtField" value="<?php echo $row['tekperkantoranp']; ?>"></td>
<td><input type="text" name="destekperkantoranp[]" class="txtField" value="<?php echo $row['destekperkantoranp']; ?>"></td>
<td><input type="text" name="tekperkantorank[]" class="txtField" value="<?php echo $row['tekperkantorank']; ?>"></td>
<td><input type="text" name="destekperkantorank[]" class="txtField" value="<?php echo $row['destekperkantorank']; ?>"></td>
