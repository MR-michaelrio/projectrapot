...
<td>Nama</td>
<td>NIS</td>
<td align=center>Korespondensi<br>Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Korespondensi<br>Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="korespondensip[]" class="txtField" value="<?php echo $row['korespondensip']; ?>"></td>
<td><input type="text" name="deskorespondensip[]" class="txtField" value="<?php echo $row['deskorespondensip']; ?>"></td>
<td><input type="text" name="korespondensik[]" class="txtField" value="<?php echo $row['korespondensik']; ?>"></td>
<td><input type="text" name="deskorespondensik[]" class="txtField" value="<?php echo $row['deskorespondensik']; ?>"></td>
