...
<td>Nama</td>
<td>NIS</td>
<td align=center>Kearsipan Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Kearsipan Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="arsipp[]" class="txtField" value="<?php echo $row['arsipp']; ?>"></td>
<td><input type="text" name="desarsipp[]" class="txtField" value="<?php echo $row['desarsipp']; ?>"></td>
<td><input type="text" name="arsipk[]" class="txtField" value="<?php echo $row['arsipk']; ?>"></td>
<td><input type="text" name="desarsipk[]" class="txtField" value="<?php echo $row['desarsipk']; ?>"></td>
