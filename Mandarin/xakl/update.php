...
<td>Nama</td>
<td>NIS</td>
<td align=center>Mandarin Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Mandarin Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="mandap[]" class="txtField" value="<?php echo $row['mandap']; ?>"></td>
<td><input type="text" name="desmandap[]" class="txtField" value="<?php echo $row['desmandap']; ?>"></td>
<td><input type="text" name="mandak[]" class="txtField" value="<?php echo $row['mandak']; ?>"></td>
<td><input type="text" name="desmandak[]" class="txtField" value="<?php echo $row['desmandak']; ?>"></td>
