...
<td>Nama</td>
<td>NIS</td>
<td align=center>Simdig Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Simdig Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="simdigp[]" class="txtField" value="<?php echo $row['simdigp']; ?>"></td>
<td><input type="text" name="dessimdigp[]" class="txtField" value="<?php echo $row['dessimdigp']; ?>"></td>
<td><input type="text" name="simdigk[]" class="txtField" value="<?php echo $row['simdigk']; ?>"></td>
<td><input type="text" name="dessimdigk[]" class="txtField" value="<?php echo $row['dessimdigk']; ?>"></td>
