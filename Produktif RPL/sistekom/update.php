...
<td>Nama</td>
<td>NIS</td>
<td align=center>Sistekom Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Sistekom Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="sistekomp[]" class="txtField" value="<?php echo $row['sistekomp']; ?>"></td>
<td><input type="text" name="dessistekomp[]" class="txtField" value="<?php echo $row['dessistekomp']; ?>"></td>
<td><input type="text" name="sistekomk[]" class="txtField" value="<?php echo $row['sistekomk']; ?>"></td>
<td><input type="text" name="dessistekomk[]" class="txtField" value="<?php echo $row['dessistekomk']; ?>"></td>
