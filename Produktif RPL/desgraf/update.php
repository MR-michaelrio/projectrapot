...
<td>Nama</td>
<td>NIS</td>
<td align=center>Desgraf Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Desgraf Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="desgrafp[]" class="txtField" value="<?php echo $row['desgrafp']; ?>"></td>
<td><input type="text" name="desdesgrafp[]" class="txtField" value="<?php echo $row['desdesgrafp']; ?>"></td>
<td><input type="text" name="desgrafk[]" class="txtField" value="<?php echo $row['desgrafk']; ?>"></td>
<td><input type="text" name="desdesgrafk[]" class="txtField" value="<?php echo $row['desdesgrafk']; ?>"></td>
