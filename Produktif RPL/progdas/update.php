...
<td><input type="text" name="despemrogramanp[]" class="txtField" value="<?php echo $row['despemrogramanp']; ?>"></td>
<td><input type="text" name="pemrogramank[]" class="txtField" value="<?php echo $row['pemrogramank']; ?>"></td>
<td><input type="text" name="despemrogramank[]" class="txtField" value="<?php echo $row['despemrogramank']; ?>"></td>
