...
<td>Nama</td>
<td>NIS</td>
<td align=center>Etika Profesi Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Etika Profesi Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="etprofp[]" class="txtField" value="<?php echo $row['etprofp']; ?>"></td>
<td><input type="text" name="desetprofp[]" class="txtField" value="<?php echo $row['desetprofp']; ?>"></td>
<td><input type="text" name="etprofk[]" class="txtField" value="<?php echo $row['etprofk']; ?>"></td>
<td><input type="text" name="desetprofk[]" class="txtField" value="<?php echo $row['desetprofk']; ?>"></td>
