...
<td>Nama</td>
<td>NIS</td>
<td align=center>Akuntansi Dasar<br>Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Akuntansi Dasar<br>Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="akunp[]" class="txtField" value="<?php echo $row['akunp']; ?>"></td>
<td><input type="text" name="desakunp[]" class="txtField" value="<?php echo $row['desakunp']; ?>"></td>
<td><input type="text" name="akunk[]" class="txtField" value="<?php echo $row['akunk']; ?>"></td>
<td><input type="text" name="desakunk[]" class="txtField" value="<?php echo $row['desakunk']; ?>"></td>
