...
<td>Nama</td>
<td>NIS</td>
<td align=center>Spreadsheet Pengetahuan</td>
<td align=center>Deskripsi</td>
<td align=center>Spreadsheet Keterampilan</td>
<td align=center>Deskripsi</td>
</tr>
<?php
 include 'koneksi.php';
...
<td><input type="text" name="ssp[]" class="txtField" value="<?php echo $row['ssp']; ?>"></td>
<td><input type="text" name="desssp[]" class="txtField" value="<?php echo $row['desssp']; ?>"></td>
<td><input type="text" name="ssk[]" class="txtField" value="<?php echo $row['ssk']; ?>"></td>
<td><input type="text" name="desssk[]" class="txtField" value="<?php echo $row['desssk']; ?>"></td>
